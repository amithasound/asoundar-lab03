...
public class ArrayStack<T> implements Stack<T>
{
     ...
     * Modified by V. Gehlot (02/04/2022). 
     * Uses methods from java.util.Arrays and java.util.Collections
     * to copy and reverse contents so as to return string with
     * the stack in the top (left) to bottom (right) order.
     * @return a string representation of the stack
     */
    public String toString()
    {
    	T[] contents = Arrays.copyOf(stack, size());
    	java.util.Collections.reverse(Arrays.asList(contents));
